...
export const Logo = () => {
  const vector = `
    <svg viewBox="0 0 389 389" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="194.5" cy="194.5" r="162.5" fill="#A8E2F4"/>
    <path class="wave" d="M215.5 226.65C175.363 250.778 123.03 248.685 77 226.65C126.683 270.014 178.5 266.5 227.5 246.746C258 234.45 309.191 242.287 357.5 276.65C305.909 239.953 255.637 202.521 215.5 226.65Z" fill="#C4C4C4"/>
    <path class="wave" d="M215.5 149.65C175.363 173.778 123.03 171.685 77 149.65C126.683 193.014 178.5 189.5 227.5 169.746C258 157.45 309.191 165.287 357.5 199.65C305.909 162.953 255.637 125.521 215.5 149.65Z" fill="#C4C4C4"/>
    ...
    <path class="wave" d="M215.5 188.65C175.363 212.778 123.03 210.685 77 188.65C126.683 232.014 178.5 228.5 227.5 208.746C258 196.45 309.191 204.287 357.5 238.65C305.909 201.953 255.637 164.521 215.5 188.65Z" fill="#C4C4C4"/>
    </svg>
  `;
